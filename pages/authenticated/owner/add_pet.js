...
import { provinceList, animalType, speciess, birthYear, animalSex} from '../../../data/direct'
...
export default function AddPet() {
    ...
    return (
        <div>
                    ...
                    {({
                        ...
                        <div className="upload__image-wrapper">
                         ...
                         &nbsp;
                            ...
                            {errors && <div>
                                {errors.maxNumber && <span>คุณใส่รูปเกินจำนวน ({maxNumber}) รูป</span>}
            ...
            <div className='w-auto min-w-max xl:w-1/2 my-2 md:w-3/4 md:px-24 p-8 m-auto shadow-2xl bg-gray-50'>
                <h3 className="mb-4">ข้อมูลสัตว์เลี้ยง</h3>
                <div className="mx-3 md:flex">
                    <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                        <TextSelectInput id="animal_type" label="ประเภท" options={animalType} value={province} onChange={e => setProvince(e)} placeholder="เลือกประเภท" required={true}></TextSelectInput>
                    </div>
                    <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                        <TextSelectInput id="species" label="สายพันธุ์" options={speciess} value={district} onChange={e => setDistrict(e)} placeholder="เลือกสายพันธุ์"></TextSelectInput>
                    </div>
                </div>
                <div className="mx-3 md:flex">
                    <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                        <TextSelectInput id="birth_year" label="ปีเกิด" className="w-1/2" options={birthYear} value={province} onChange={e => setProvince(e)} placeholder="เลือกปีเกิด"></TextSelectInput>
                    </div>
                    <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                        <TextSelectInput id="sex" label="เพศ" className="w-1/2" options={animalSex} value={district} onChange={e => setDistrict(e)} placeholder="เลือกเพศ"></TextSelectInput>
                    </div>
                </div>
                <div className="mx-3 md:flex">
                    <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                        <TextInput id="disease" label="โรคประจำตัว"></TextInput>
                    </div>
                </div>
            </div>
            <div className='w-auto min-w-max xl:w-1/2 my-2 md:w-3/4 md:px-24 p-8 m-auto shadow-2xl bg-gray-50'>
